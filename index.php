...
<body style="background-color: darkgrey;">
    ...
    <form action= "pagina1.php" method= "post" >      
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Sobrenome">
          </div>
        
        <div class="form-group">
            <label for="exampleInputEmail1"style="font-size:25PX">Endereço de email</label>
...
<php
    ...
    $servidor = "localhost";
    $usuario = "id20466435_coutinho";
    $senha = "Marcos242714.";
    $nomedb = "id20466435_coutinhoteste1";
